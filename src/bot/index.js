...
bot.onText(/\/start(?:\s+ref[_-]?([\w-]+))?/, async (msg, match) => {
  ...
  const welcomeText = `<b>Привет,</b> 👋\n\n` +
    ...
    '🚫 Никаких ограничений скорости — полная свобода в интернете\n' +
    '⚙️ Быстрое подключение — легко настроить за 1 минуту\n' +
    '🔒 Конфиденциальность и безопасность\n' +
    '💵 Всего 180₽ в месяц — без скрытых платежей\n' +
    '💳 Не принимаем платежи напрямую по карте\n\n' +
    '🔌 Наш VPN доступен на iPhone, Android, ПК, macOS';
